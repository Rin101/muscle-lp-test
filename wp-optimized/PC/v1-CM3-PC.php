        ...
        <div class="footer-container">
            ...
            <div class="footer-buttons">
                <div class="see-product-container">
                    <a class="CM3-PC-a" href="https://musclecorp.com/motion/cm3-top/" class="see-product">
                        <p><i class="fas fa-external-link-alt"></i> CM３製品概要を見る</p>
                    </a>
                </div>
                <div class="catalog-download-container">
                    <a class="CM3-PC-a" href="https://musclecorp.com/motion/coolmuscle3newcatalog/" class="catalog-download">
                        <p><i class="fas fa-download"></i> カタログダウンロード</p>
                    </a>
                </div>
                <div class="contact-container">
                    <a class="CM3-PC-a" href="https://musclecorp.com/motion/contactus/" class="contact">
